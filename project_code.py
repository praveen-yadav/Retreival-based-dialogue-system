...
def get_cosine(sen1, sen2):
	...
	vectors2 = vectors2/c2
	numerator=vectors.dot(vectors2)
	mag1 = np.sqrt(vectors.dot(vectors))
	mag2 = np.sqrt(vectors2.dot(vectors2))
	denom = mag1*mag2
	ans=numerator/denom
	return ans
...
while 1:
	...
	if user_text.startswith("goodbye"):
		break	
